namespace BugTracker.Tests
{
    ...
    //        });
    //        var httpResponse = HttpClient.PostAsync("/api/user/register", postContent).Result;
    //        return httpResponse;
    //    }
    ...
    //            new KeyValuePair<string, string>("password", password)
    //        });
    //        var httpResponse = HttpClient.PostAsync("/api/user/login", postContent).Result;
    //        return httpResponse;
    //    }
    ...
    //        var httpResponse = HttpClient.GetAsync("/api/bugs/filter?" + queryString).Result;
    //        return httpResponse;
    //    }
    //}
}
