namespace News.Repositories.Tests
{
    ...
    //before run these teste the database from connection string (initial catalog=News.WebServicesIntefrationTest) should already to be lift up
    //make a query with Postman will lift the database up
