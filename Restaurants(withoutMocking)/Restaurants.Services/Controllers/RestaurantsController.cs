...
namespace Restaurants.Services.Controllers
{
    ...
    public class RestaurantsController : BaseApiController
    {
        ...
        {
            var town = this.Context.Towns.Find(townId);
            if (town == null)
            {
                return this.BadRequest("Invalid town id: " + townId);
            }
            
            var restaurants = this.Context.Restaurants
        ...
        public IHttpActionResult CreateNewRestaurant(CreateRestaurantBindingModel model)
        {
            ...
            var town = this.Context.Towns.Find(model.TownId);
            ...
            if (this.Context.Restaurants.Any(r => r.Name == model.Name))
            {
            ...
            var newRestaurantFromDb = this.Context.Restaurants
        ...
        public IHttpActionResult RateRestaurant(int id, RateRestaurantBindingModel model)
        {
            ...
            if (this.Context.Ratings.Any(r => r.UserId == loggedUserId && r.RestaurantId == restaurant.Id))
            {
                var rate = this.Context.Ratings.
            ...
            else
            {
                ...
                this.Context.Ratings.Add(newRate);
            }
